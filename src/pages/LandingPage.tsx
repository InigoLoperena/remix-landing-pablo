...
import { HeroSection, TheCoreLoopSection, TheManifestoSection, AddLootSection, FaqSection, WastelandProvidesSection } from '@/components/wasteland/WastelandSections';
