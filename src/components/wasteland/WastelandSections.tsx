...
export const WastelandProvidesSection = () => {
  const finds = [
    {
      img: '/street-finds/find-web%20%281%29.webp',
    ...
    {
      img: '/street-finds/find-web%20%282%29.webp',
    ...
    {
      img: '/street-finds/find-web%20%283%29.webp',
      title: 'MINT ARMCHAIR',
    ...
    {
      img: '/street-finds/find-web%20%284%29.webp',
